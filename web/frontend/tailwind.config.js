  ...
  theme: {
    extend: {
      colors: {
        ...
        'lens-surface-4': '#3F4C51',
        'lens-surface-5': '#354044', // lens-medium-eased
        'lens-surface-6': '#2d383c', // lens-medium
        'lens-surface-7': '#192428', // lens-dark

        'lens-text-0': '#D5DFEA', // lens-bright
        'lens-text-1': '#C3C7CC', // lens-light-eased
        'lens-text-2': '#B5C6E2', // lens-light,
        'lens-text-3': '#5E8EA3', // lens-bright-muted
